...
import app.complyglobal.fragment.RegisterListFragment.OnListFragmentInteractionListener;
 ...
 */
public class ListViewAdapterForRegisters extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ListViewAdapterForRegisters(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if(viewType==TYPE_HEADER){
            ...
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.register_header_file, parent, false);
