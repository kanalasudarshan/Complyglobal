...
public class RegistrationListPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Fragment fragment=new RegistrationListFragment();
        FragmentTransaction ft=getSupportFragmentManager().beginTransaction();
        ft.replace(R.id.registrations_content_list_page,fragment);
        ft.commit();
        ...
        filterBy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(RegistrationListPage.this, FilterActivity.class));
            }
        });
    }
